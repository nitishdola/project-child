                        ...
                        <div class="col-xs-6">
                           <div id="com2_stats">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-9">
                                   {!! Form::text('history', null, ['class' => ' form-control', 'id' => 'history', 'placeholder' => 'Enter History' ]) !!}
                                 </div>
                              </div>
                              ...
                              <div class="form-group">
                                   ...
                                   <div class="col-sm-9">
                                      {!! Form::select('school_id', $schools, null, ['class' => 'select2', 'id' => 'school_id', 'placeholder' => 'Select School' ]) !!}
                                   </div>
                                </div>
